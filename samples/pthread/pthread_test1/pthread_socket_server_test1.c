      ...
      if(p > 0)
      {
         ...
         else
         {
            if(pafds[0].revents & POLLIN)
            {
               ...
               printf("here5!! readable!!\n"); //test3
            }
            if(pafds[0].revents & POLLOUT)
            {
               printf("here6!! writable!!\n"); //test3
               write(pafds[0].fd, "Thank!!\n", strlen("Thank!!\n") + 1);
               pafds[0].revents &= ~POLLOUT;
            }
         }
      }
      sleep(5); //test2
